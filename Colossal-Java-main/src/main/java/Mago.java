...
- É a classe "mãe" de todos os tipos de magos (Arcano, Elemental, Sombrio).
- Contém todos os atributos e comportamentos que um mago tem, como vida, mana, poder,
  lista de feitiços (grimório) e a lista de efeitos de status ativos.
- Define as constantes para Foco, Controlador e Perfis de IA, consolidando as definições.
- Inclui a lógica da IA para escolher feitiços com base no seu perfil (Agressivo ou Oportunista).
- Gere os efeitos de status a cada turno (processarEfeitosDoTurno).
=============================================================================================
*/